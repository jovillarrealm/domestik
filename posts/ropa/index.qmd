...
* **Mecanismo:** su alcalinidad ayuda a hinchar fibras, desprender suciedad y mejorar el trabajo de los tensioactivos, además de controlar parte de la dureza del agua. La saponificación de triglicéridos requiere normalmente una base mucho más fuerte y condiciones controladas; no debe presentarse al carbonato doméstico como si fabricara jabón rápidamente dentro de la lavadora. Es una herramienta para ropa resistente y productos que lo autoricen, no para lana, seda o prendas delicadas.3
...
* **Intuición de Uso:** puede ayudar con grasa y residuos alcalinos porque mejora la humectación y el trabajo del detergente, pero no es un desengrasante mágico. Su volatilidad implica riesgos respiratorios y nunca debe mezclarse con hipocloritos.3
...
* **Mecanismo:** forma especies oxidantes que pueden alterar estructuras pigmentadas. La química exacta depende de concentración, pH, luz, metales y formulación; no conviene prometer una especie radical concreta como si apareciera siempre.
* **Intuición:** puede ayudar en manchas orgánicas de telas compatibles, pero también puede aclarar tintes y debilitar fibras. “Más suave que el cloro” no significa seguro para toda ropa de color.2
...
* **Intuición:** *Nunca* usar cloro o sosa cáustica en lana o seda. Para detergentes enzimáticos y ácidos, seguir la etiqueta de la prenda y del producto: una receta casera con vinagre no es una autorización universal para fibras proteicas.14
...
| **Vinagre + Agua Oxigenada** | Mezcla oxidante ácida no controlada | No mezclar ni guardar. Aunque puede formarse ácido peracético, la concentración y el riesgo son desconocidos; enjuagar completamente entre productos no convierte una mezcla casera en protocolo validado.2 |
...
* **Intuición:** proporciona alcalinidad que ayuda al detergente a trabajar y peróxido para oxidar pigmentos amarillos. No asumir que el carbonato saponifica por completo la grasa oxidada en una carga doméstica.22
* **Procedimiento:**  
...
* **Agua caliente:** puede ayudar a disolver algunos azúcares, pero no es una receta universal y puede fijar proteínas, mover tintes o dañar acabados. Empieza con agua fría/fresca por el reverso y sigue la etiqueta de la prenda; reserva temperaturas altas para el lavado permitido.
...
* **Límite:** no presentar vinagre como fungicida universal ni el color negro como simple pigmento separado del crecimiento. En textiles y juntas porosas, limpiar, secar y corregir humedad; si se usa un oxidante o desinfectante, seguir su etiqueta y no combinarlo con restos de ácido. Si la silicona está colonizada o deteriorada, reemplazarla.32
...
* **Solución:** removedor de óxido compatible.
* **Mecanismo:** un ácido o producto formulado puede solubilizar parte de los compuestos de hierro; el citrato puede complejar hierro. La sal no es necesaria y sus cloruros pueden favorecer corrosión en metales.
* **Procedimiento:** en ropa, usar removedor para textiles y probar primero; en herramientas, usar un producto compatible, enjuagar, secar y proteger. No generalizar una receta de limón y sal a ropa, herramientas y pisos.41
...
: Tabla Maestra de Intuición y Solución {#tbl-letters}
...
La intuición química reduce el ensayo y error, pero no lo elimina: concentración, etiqueta, fibra, tinte y tiempo cambian el resultado. El objetivo de estos principios es saber cuándo detenerse y cuándo usar un producto formulado o un profesional, no convertir una receta casera en garantía de seguridad.
